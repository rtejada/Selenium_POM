...
class FillEmployeeInfo(SuitecrmBasePage):
    ...
    EMPLOYEE_INFO = {"TITLE_EMPLOYEE": (By.ID, 'title'), "PHONE_WORK": (By.ID, 'phone_work'), "PHONE_MOBILE": (By.ID, 'phone_mobile'),
                     ...
                     "MESSENGER_TYPE": (By.ID, 'messenger_type'), "MESSENGER_ACCOUNT": (By.ID, 'messenger_id'), "ADDRESS_STREET": (By.ID, 'address_street'),
                     "ADDRESS_CITY": (By.ID, 'address_city'), "ADDRESS_STATE": (By.ID, 'address_state'), "CP": (By.ID, 'address_postalcode'),
                     "ADDRESS_COUNTRY": (By.ID, 'address_country'), "DESCRIPTION": (By.ID, 'description'), "EMAIL": (By.ID, 'Users0emailAddress0')
                     }
    ...
    def fill(self):
        ...
        self.fill_text_field(self.EMPLOYEE_INFO['ADDRESS_STREET'], self.DATA_USERS['street address'])

        self.fill_text_field(self.EMPLOYEE_INFO['ADDRESS_CITY'], self.DATA_USERS['city of address'])
        ...
        self.fill_text_field(self.EMPLOYEE_INFO['ADDRESS_COUNTRY'], self.DATA_USERS['Country_of_address'])
